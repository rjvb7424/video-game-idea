...
# internal imports
from ui_elements import draw_title_text, draw_header_text, draw_body_text, draw_accept_button, draw_deny_button
from ui_elements import BG_COLOR

def main():
    pygame.init()
    # obtain display info for initial window size
